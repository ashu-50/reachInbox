...
const envSchema = z.object({
    ...
    ELASTICSEARCH_API_KEY: z
        .string()
        .min(1, "ELASTICSEARCH_API_KEY is required"),
    GOOGLE_CLIENT_ID: z
        .string()
        .optional()
        .default(""),
    ...
    WORKER_CONCURRENCY: z
        ...
        .positive()
        .default(5),
    MIN_EMAIL_DELAY_MS: z
        .coerce
        .number()
        .int()
        .nonnegative()
        .default(2000),
    MAX_EMAILS_PER_HOUR: z
        .coerce
        .number()
        .int()
        .positive()
...
export function isSlackConfigured() {
    return Boolean(env.SLACK_CLIENT_ID &&
        env.SLACK_CLIENT_SECRET);
}
export function isEtherealConfigured() {
    return Boolean(env.ETHEREAL_HOST &&
        env.ETHEREAL_USER &&
